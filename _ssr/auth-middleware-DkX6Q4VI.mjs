...
//#region node_modules/.nitro/vite/services/ssr/assets/auth-middleware-DkX6Q4VI.js
...
var requireSupabaseAuth = createMiddleware({ type: "function" }).server(async ({ next }) => {
	...
	if (authHeader && authHeader.startsWith("Bearer ")) {
		...
		if (token && token.split(".").length === 3 && !SUPABASE_PUBLISHABLE_KEY.includes("dummy")) try {
	...
	try {
		fallbackSupabase = createClient(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, {
